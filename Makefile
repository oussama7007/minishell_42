...
# === Source files ===
HAMOU_SRC := \
	$(C_HAMOU_DIR)/commands.c $(C_HAMOU_DIR)/ex.c $(C_HAMOU_DIR)/free.c $(C_HAMOU_DIR)/tokenization.c $(C_HAMOU_DIR)/helper_fuc.c  $(C_HAMOU_DIR)/utils.c $(C_HAMOU_DIR)/tokens_utils2.c  $(C_HAMOU_DIR)/expand.c srcs/main.c srcs/signal_handler.c
