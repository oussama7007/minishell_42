...
SPUVR_SRC := \
	...
	$(C_SPUVR_DIR)/unset_exit/ft_unset.c $(C_SPUVR_DIR)/unset_exit/ft_exit_child.c $(C_SPUVR_DIR)/ft_env/ft_env.c $(C_SPUVR_DIR)/ft_execut/error.c $(C_SPUVR_DIR)/ft_execut/util.c \
