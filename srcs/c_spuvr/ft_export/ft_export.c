...
/*   Updated: 2025/05/25 19:32:16 by oait-si-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	}
// 	if (!my_getenv(name_arg, *env_ptr))
// 		return (my_setenv(head ,(char *)name_arg, NULL, env_ptr));
// 	return (0);
// }
...
// 	if (!args[1])
// 	{
// 		display_sorted_environment(head,*env_ptr);
// 		return (0);
// 	}
// 	return (process_export_arguments(head, args, env_ptr));
// }
